...
describe 'Get Latest Deployment', ->
  ...
  describe 'On GET /deployments/:owner_name/:repo_name/latest', ->
    ...
    context 'when a deployment exists with valid tags', ->
      ...
      beforeEach (done) ->
        options =
          uri: '/deployments/the-owner/the-service/latest?tags=valid-tag,another-valid-tag'
          baseUrl: "http://localhost:#{@serverPort}"
          json: true
          auth:
            username: 'the-username'
    ...
    context 'when a deployment exists with extra tags', ->
      beforeEach (done) ->
        record =
          owner_name: 'the-owner'
          repo_name: 'the-service'
      ...
      beforeEach (done) ->
        options =
          uri: '/deployments/the-owner/the-service/latest?tags=another-valid-tag'
          baseUrl: "http://localhost:#{@serverPort}"
          json: true
          auth:
            username: 'the-username'
    ...
    context 'when a deployment exists with an invalid tag', ->
      beforeEach (done) ->
        record =
          owner_name: 'the-owner'
          repo_name: 'the-service'
      ...
      beforeEach (done) ->
        options =
          uri: '/deployments/the-owner/the-service/latest?tags=valid-tag'
          baseUrl: "http://localhost:#{@serverPort}"
          json: true
          auth:
            username: 'the-username'
